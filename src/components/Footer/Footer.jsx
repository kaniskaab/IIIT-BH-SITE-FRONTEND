  ...
  return (
    <div>
      <footer
        ...
        className="overflow-hidden relative bg-gray-50 z-[1]"
        style={{ backgroundColor: 'rgb(228,228,228)' }}
      >
        <div className="mx-auto max-w-screen-xl space-y-12 px-4 py-16 sm:px-6 lg:px-8">
          <div ref={footHeadRef} className="grid grid-cols-8 gap-x-5 text-3xl">
            <img
              alt="logo"
              src="./images/IIIT-Bh-Logo-removebg.png"
              className="p-5 justify-items-centre mix-blend-multiply h-[[80px] sm:h-[[100px]"
              style={{ marginRight: '0px' }}
            />
            <div className="flex flex-col col-span-5 p-2">
              <div className="flex flex-row">
                <span>
                  International Institite of Information Technology, Bhubaneswar
                </span>
              </div>
              <div className="text-sm">
                <div className="py-1">
                  ...
                  <span>
                    Gothapatna, PO: Malipada, Bhubaneswar-751003, India
                  </span>
                </div>
                <div className="py-1">
                  <FontAwesomeIcon icon={faEnvelope} className="px-2" />
                  <span>offdean@iiit-bh.ac.in</span>
                </div>
                <div className="py-1">
                  <FontAwesomeIcon icon={faPhone} className="px-2" />
                  <span>674-2653-300</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-8 border-t border-gray-100 pt-12 sm:grid-cols-2 lg:grid-cols-4">
            <div>
          ...
          <p className="text-xs text-gray-500">&copy; 2022 IIIT-Bh</p>
        </div>
      </footer>
    </div>
  );
