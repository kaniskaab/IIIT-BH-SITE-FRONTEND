...
const AdmissionSectionM = ({ type }) => {
  ...
  const btechNotices = notices.filter((notice) => notice.type === 'MTECH');
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center text-white font-poppins overflow-y-scroll" id="mtech">
      ...
      <div className="flex flex-col md:flex-row justify-center mt-8 w-full h-full">
        ...
        >
          <h2 className="text-lg font-semibold mb-4 text-orange-500">MTECH Notices:</h2>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
        >
          <h2 className="text-lg font-semibold mb-4 text-orange-500">MTECH Resources:</h2>
...
export default AdmissionSectionM;
