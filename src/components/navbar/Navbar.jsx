  ...
  },
  {
    ...
    sublinks: [
      { name: 'About', submenu: false, link: '/about' },
      {
        ...
        link: '/',
        sublinks: [
          { name: 'Resources', submenu: false, link: '/university/resources' },
          { name: 'IIIT Act', submenu: false, link: '/university/iiitact' },
          {
            name: 'IIIT Statute',
            submenu: false,
            link: '/university/iiitstatue',
          },
          { name: 'BOG', submenu: false, link: '/university/bog' },
          { name: 'NIRF', submenu: false, link: '/university/nirf' },
          { name: 'RTI', submenu: false, link: '/university/rti' },
          { name: 'AICTE', submenu: false, link: '/university/aicte' },
          {
            name: 'heya',
            submenu: true,
            link: '/',
      ...
      { name: 'Administration', submenu: false, link: '/university/admission' },
      ...
      { name: 'Tenders', submenu: false, link: '/' },
      {
        ...
        sublinks: [
          { name: 'Library', submenu: false, link: '/' },
          {
            ...
            submenu: false,
            link: '/university/online-grievance-redressal',
          },
          {
            name: 'Feedback facility',
            submenu: false,
            link: '/university/feedbackstudent',
          },
          {
            name: 'SC/ST/OBC Cell',
            submenu: false,
            link: '/university/scstobc-cell',
          },
        ],
      },
    ],
