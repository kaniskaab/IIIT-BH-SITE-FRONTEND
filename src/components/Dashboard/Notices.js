      ...
      <AnimatePresence>
        {isModalOpen && (
          <motion.div
            ...
            className="fixed top-30 right-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-[48%] h-1/2 rounded-lg shadow-lg flex flex-col items-center justify-center text-[15px]" onScroll={handleCloseModal}
          >
            <h2 className="text-lg font-bold mb-4">{selectedNotice.title}</h2>
            <p>Date of Upload: {selectedNotice.date}</p>
